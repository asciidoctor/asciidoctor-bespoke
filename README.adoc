...
TIP: If you're creating a new project using the starter project previously mentioned, you can switch to the `asciidoc` branch in that repository to skip the steps in this section and jump ahead to <<Creating Slides in AsciiDoc>>.
...
Here's a close approximation of the HTML the converter generates for the example shown above (formatted for clarity).
