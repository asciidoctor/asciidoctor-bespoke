...
{project-name} enables you to create HTML-based presentations without having to suffer the tedium of writing HTML by hand.
This converter is responsible for generating the HTML component of a Bespoke.js presentation from a master AsciiDoc document.
In other words, it allows you to use AsciiDoc in place of HTML (or an HTML template language like Jade) in your presentation project.
