...
Currently, there are two insertion locations for docinfo content in a Bespoke document:

head:: content is inserted after the the last child of the `<head>` element
footer:: content is inserted after the last child of the `<article>` element
